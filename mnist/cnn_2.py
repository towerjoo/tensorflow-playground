...
class SimpleModel:
    def __init__(self):
        ...
        self.train_model = self.get_model(self.X, conv1, conv2, fc1, fc2, self.p_keep_conv, self.p_keep_hidden)

    def get_model(self, X, conv1, conv2, fc1, fc2, p_keep_conv, p_keep_hidden):
